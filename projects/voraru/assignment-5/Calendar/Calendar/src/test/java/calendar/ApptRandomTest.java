...
public class ApptRandomTest {
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
			 ...
			 // Check isValid() by checking boundary conditions randomly
			 ...
			 assertTrue(appt.getValid());
			 appt.setStartDay(ValuesGenerator.getRandomIntBetween(random, 1, 28));
			 assertTrue(appt.getValid()); 
			 appt.setStartMonth(ValuesGenerator.getRandomIntBetween(random, 1, 12));
			 assertTrue(appt.getValid());

			 appt.setStartHour(ValuesGenerator.getRandomIntBetween(random, 25, 45));
			 assertFalse(appt.getValid());
			 appt.setStartMinute(ValuesGenerator.getRandomIntBetween(random, 85, 99));
			 assertFalse(appt.getValid());
			 appt.setStartDay(ValuesGenerator.getRandomIntBetween(random, 35, 70));
			 assertFalse(appt.getValid()); 
			 //appt.setStartMonth(ValuesGenerator.getRandomIntBetween(random, 45, 80));
			 //assertFalse(appt.getValid()); 
